...
export function initialize() {
    ...
    $("#compose_banners").on(
        ...
        (event) => {
            ...
            const $target = $(event.target).parents(`.${compose_error.CLASSNAMES.topic_resolved}`);
    ...
    $("#compose_banners").on(
        ...
        (event) => {
            ...
            const $invite_row = $(event.target).parents(
                `.${compose_error.CLASSNAMES.recipient_not_subscribed}`,
            );
