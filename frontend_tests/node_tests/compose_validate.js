...
test_ui("validate_stream_message_address_info", ({mock_template}) => {
    ...
    mock_template("compose_banner/stream_does_not_exist_error.hbs", true, (data, html) => {
...
test_ui("warn_if_mentioning_unsubscribed_user", ({override, mock_template}) => {
    ...
    mock_template("compose_banner/not_subscribed_warning.hbs", false, (data) => {
        ...
        return "recipient_not_subscribed_stub";
    });
    ...
    function test_noop_case(is_private, is_zephyr_mirror, is_broadcast) {
        ...
        mentioned_user.is_broadcast = is_broadcast;
        compose_validate.warn_if_mentioning_unsubscribed_user(mentioned_user);
    ...
    people.add_active_user(mentioned_user);
