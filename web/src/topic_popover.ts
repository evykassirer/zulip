...
export function open_cross_topic_links(
    ...
    popover_menus.toggle_popover_menu(target, {
        ...
        onShow(instance) {
            ...
            const links_from_narrow = message_store.topic_links_from_narrow(stream_id, topic_name);
            const links_to_narrow = message_store.topic_links_to_narrow(stream_id, topic_name);
            const context = {
