...
export function pm_reply_user_string(message: Message | RawMessage): string | undefined {
...
export function pm_with_user_ids(
    message: (Message | RawMessage) & {reply_to?: string; url?: string},
): number[] | undefined {
    if (message.type !== "private") {
        return undefined;
    }
...
export function pm_with_url(message: Message | RawMessage): string | undefined {
    const user_ids = pm_with_user_ids(message);
