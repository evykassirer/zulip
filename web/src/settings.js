...
export function build_page() {
    ...
    console.log(people.small_avatar_url_for_person(people.get_by_user_id(people.my_current_user_id())))
    const rendered_settings_tab = render_settings_tab({
        full_name: people.my_full_name(),
        profile_picture: people.small_avatar_url_for_person(people.get_by_user_id(people.my_current_user_id())),
