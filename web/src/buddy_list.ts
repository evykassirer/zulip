            ...
            function (this: HTMLElement, e) {
                ...
                tippy.default(util.the($elem), {
                    ...
                    onShow(instance) {
                        ...
                        // TODO(evy) is there a way to access this on the buddy list class? Or do
                        // we have to recalculate it here?
                        assert(message_lists.current !== undefined);
                        const participant_ids_set = new Set(
                        ...
                        if (elem_id === "buddy-list-participants-section-heading") {
                            ...
                            if (participant_ids_set.size) {
                                tooltip_text = $t(
                                    ...
                                    {N: total_human_subscribers_count - participant_ids_set.size},
                                );
                            } else if (current_sub) {
                                tooltip_text = $t(
                                    {
