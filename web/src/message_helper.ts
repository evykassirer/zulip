...
export function process_new_message(opts: NewMessage): Message {
    ...
    if (message_with_booleans.message.type === "stream") {
        ...
        if (message_with_booleans.type === "server_message") {
            ...
            // TODO(evy) can we know these aren't undefined?
            assert(rest.avatar_url !== undefined);
            ...
            message = {
                ...
                // TODO(evy) investigate/fix these
                recipient_id: 1, // ?
                submessages: [],
            };
        }
        ...
        if (message_with_booleans.type === "server_message") {
            ...
            message = {
                ...
                // TODO(evy) investigate/fix these
                submessages: [],
                recipient_id: 1, // ?? where is this set for local messages
            };
        }
